    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Display Name");
            ...
            case R.id.btn_move_activity_object:
                Mhs mhs = new Mhs();
                mhs.setNpm("10203040");
                mhs.setNama("I Komang");
                mhs.setKelas("1A");
                mhs.setUmur(20);
                Intent moveWithObjectIntent = new Intent(MainActivity.this, MoveWithObjectActivity.class);
                moveWithObjectIntent.putExtra(MoveWithObjectActivity.EXTRA_MHS, mhs);
                startActivity(moveWithObjectIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "082299443925";
